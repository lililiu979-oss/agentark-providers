![AgentArk Provider Hub](./assets/provider-hub-cover.svg)

# AgentArk Provider Hub

[![Website](https://img.shields.io/badge/website-agentarktalent.com-0F172A?style=flat-square)](https://agentarktalent.com)
...
- a provider application template
- a workflow packaging template
- a proof-of-work checklist
- a buyer intake template
- a provider readiness scorecard
- example provider profiles
- a buyer-provider fit matrix
- contribution and showcase paths for public credibility

Start here:

- [Apply as a provider](https://github.com/lililiu979-oss/agentark-providers/issues/new?template=provider-application.yml)
- [Suggest a resource](https://github.com/lililiu979-oss/agentark-providers/issues/new?template=resource-suggestion.yml)
- [Workflow offer template](./resources/workflow-offer-template.md)
- [Proof-of-work checklist](./resources/proof-of-work-checklist.md)
- [Buyer intake template](./resources/buyer-intake-template.md)
- [Provider positioning checklist](./resources/provider-positioning-checklist.md)
- [Provider readiness scorecard](./resources/provider-readiness-scorecard.md)
- [Buyer-provider fit matrix](./resources/buyer-provider-fit-matrix.md)
- [Example SEO operations provider profile](./resources/example-provider-profile-seo-ops.md)
- [Example support operations provider profile](./resources/example-provider-profile-support.md)
...
3. Open a provider application issue with real examples and scope.
4. If accepted, we will follow up through AgentArk.
